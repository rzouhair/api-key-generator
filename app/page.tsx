...
import { homePageText } from '@/lib/markdown'
    ...
    <main className='max-w-screen-md w-full mx-auto px-4'>
      ...
      <section>
        <Card className='w-full mx-auto'>
          <CardHeader>
            <CardTitle>Generate your api keys</CardTitle>
            <CardDescription>Select an api key type you want to generate</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <section className={`${isDark ? 'prose-zinc' : 'prose'} prose-sm !max-w-full w-full mx-0`}>
          <Markdown>{ homePageText }</Markdown>
        </section>
      </section>
    </main>
  )
